export default function Contact() {
    return (
        <section class="text-gray-400 bg-gray-900 body-font relative" id="contact" dir="rtl">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-12">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">اتصل بنا</h1>
                    <p class="lg:w-2/3 mx-auto leading-relaxed text-base">نحن في فريق بزوغ نرحب بتواصلكم واستفساراتكم دائمًا. سواء كانت لديكم أسئلة، اقتراحات، أو ترغبون في التعاون معنا، لا تترددوا في مراسلتنا عبر النموذج أدناه أو من خلال قنوات الاتصال الرسمية. نسعد بخدمتكم والرد عليكم في أقرب وقت ممكن.</p>                </div>
                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <div class="flex flex-wrap -m-2">
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                <label for="name" class="leading-7 text-sm text-gray-400">الاسم</label>
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                <label for="email" class="leading-7 text-sm text-gray-400">البريد الالكتروني</label>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                <label for="message" class="leading-7 text-sm text-gray-400">الرسالة</label>
                        ...
                        <div class="p-2 w-full">
                            <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">ارسال</button>
                        </div>
                        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
                            <a class="text-indigo-400" href="mailto:buzogcom@gmail.com">buzogcom@gmail.com</a>
                            <p class="leading-normal my-5">جامعة تعز
                                <br />الجمهورية اليمنية
                            </p>
                            <span class="inline-flex gap-3">
                                ...
                                {/* Github */}
                                <a href="https://github/buzog" target="_blank" rel="noopener noreferrer">
