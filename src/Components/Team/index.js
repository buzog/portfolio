        ...
        <section class="bg-white dark:bg-gray-900" dir="rtl">
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                    <h2 class="mb-4 text-4xl tracking-tight font-normal text-gray-900 dark:text-white">فريق بزوغ</h2>
                ...
                <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    ...
                    <TeamMember name="زكريا عمر" info="مهندس برمجيات" description="..." image="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"/>
                    <TeamMember name="عبدالله توفيق" info="مهندس برمجيات" description="اهتم بتعلم تطوير تطبيقات الاندرويد باستخدام Flutter" image="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"/>
                    <TeamMember name="سماء عبدالسلام" info="مهندسة برمجيات" description="..." image="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"/>
                </div>
            </div>
        </section>
    );  
    ...
    return (
        <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
                ...
                <span class="text-gray-500 dark:text-gray-400">{props.info}</span>
